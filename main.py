...
def main():
    parser = argparse.ArgumentParser(description="Solomon Cron Coordinator (Python Version)")
    parser.add_argument("--config", type=str, help="Path to the configuration file (config.json)")
