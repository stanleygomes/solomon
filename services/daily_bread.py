...
class DailyBreadService:
    ...
    def _compile_newsletter(self, content_md: str, template_path: Path, date_str: str) -> str:
    ...
    def _send_email(self, html_content: str, template_name: str) -> None:
        self.logger.log("[daily-bread] Preparing to dispatch newsletter via generic mailer...")
